...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        # used for logging and tensorboard in Server
        args.logFilePath = f'./log/{args.dataset}_{args.model_family}_{args.algorithm}_{args.goal}_seed{args.seed}/'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--struct_loss_type', type=str, default='cka', choices=['cka', 'gram_mse', 'rdm_mse', 'rdm_cos', 'mse', 'cosine'], help='struct loss type. Can be chosed in cka, gram-mse, rdm-cos')
    ...
    print(f'new device:{args.device}')
