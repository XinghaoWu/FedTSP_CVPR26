...
# 超参数列表
# lamda_list=(0.01 0.05 0.1 0.5 1 5 10 100)
# gamma_list=(1 5 10 15 20)
lamda_list=(0.00001 0.00005 0.0001 0.0005 0.001 0.005 0.01 0.05 0.1 0.5 1 5 10 20)
...
python main.py --dataset=${Dataset} --num_classes=${num_classes} --model_family=${model_family} --local_learning_rate=0.01 --global_rounds=${global_rounds} --algorithm=FedProtoEval --local_epochs=5 --batch_size=${batch_size} --num_clients=${num_clients} --lamda=${lamda} --seed=0 --device_id=${device_id} --save_model=1 &
pids+=($!)
task_idx=$((task_idx + 1))
