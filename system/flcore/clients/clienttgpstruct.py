    ...
    def train(self):
        ...
        for step in range(max_local_epochs):
            for i, (x, y) in enumerate(trainloader):
                ...
                cka_sample = self.sample_level_CKA_alignment(rep, y, global_protos)
                cka_class  = self.class_level_CKA_alignment(rep, y, global_protos, self.device)
                loss = loss + self.lamda * cka_class + self.gamma * cka_sample
                
                # print(f'sample cka loss:{cka_sample}')
                # print(f'proto cka loss:{cka_class}')
