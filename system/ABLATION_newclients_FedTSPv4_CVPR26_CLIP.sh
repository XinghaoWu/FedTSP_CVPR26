...
openset=${16:-0}
first_stage_clients=${17:-20}
first_stage_rounds=${18:-50}
...
# 动态生成 dataset 参数
origin_dataset="${dataset}_openset_${noniid}_${alpha}_balance_${num_clients}_c0.8_u0.8"
...
do
    python main.py --dataset=${origin_dataset} \
        ...
        --openset=${openset} \
        --first_stage_clients=${first_stage_clients} \
        --first_stage_rounds=${first_stage_rounds}
done